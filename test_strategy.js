...
const analyzer = require('./src/services/analyzer.service');
...
console.log('\n--- Short Signal Test ---');
const entryShort = strategy.evaluateEntry(candles, {
  rsiLen: 20,
  rsiMaLen: 20,
  bbLength: 30,
  bbMult: 2,
...
// If no short signal, let's test evaluateExit with a position
console.log('\n--- evaluateExit Test ---');
